...
registerHelp('$230620CascadeDiagram', {
...
function $230620CascadeDiagram($p_wContainer, $p_options, $p_widgets){
...
$230620CascadeDiagram.prototype = Object.create($Traliva.$WidgetStateSubscriber.prototype);
$230620CascadeDiagram.prototype.constructor = $230620CascadeDiagram;
$230620CascadeDiagram.prototype.$processStateChanges = function(s){
	if (!s){
...
$230620CascadeDiagram.prototype.$_update = function(){
	var
		$1, $2, $3, $title,
		$accumulator = 0,
		$constMinFontSize = 10,
...
//$230620CascadeDiagram.$widgetsFields = [];
